...
HIGH_RISK_TOOLS = {
    ...
    "hdfs_setquota" : 'Установка квот может ограничить доступное пространство и нарушить работу приложений',
    'hdfs_balancer_trigger' : 'Балансировка влияет на производительность кластера и может занять длительное время'
}
